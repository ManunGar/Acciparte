...
const loadFileRoutes = (app) => {
  ...
  app.route('/users/register')
    .post(UserValidation.register, handleValidation, UserController.register)

  app.route('/users/refresh')
    .post(UserValidation.refresh, handleValidation, UserController.refresh)

  app.route('/users/me')
    .get(isLoggedIn, UserController.me)
}
